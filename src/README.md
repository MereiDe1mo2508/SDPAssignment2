...
6) I created abstract factory interface to create what we created on factory class
7) I used Main as the Client class to input data of what we have on our base and test all of our products we input

Main sources of adapting code: Refactoring guru, JavaRush, many articles and Youtube videos